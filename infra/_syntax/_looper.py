...
class Looper:
    """
    A class that handles loop processing for operators in a workspace.
    """
    ...
    def retrieve_next_base_element(self, to_loop_element_reference: Reference, current_loop_base_element: Optional[Reference] = None) -> Tuple[Optional[Reference], Optional[int]]:
    ...
    def _is_base_element_in_reference(self, base_element_to_check: Reference, to_loop_element_reference: Reference) -> bool:
        ...
        This uses the same iterative selection logic as retrieve_next_base_element to handle complex tensor structures.
        """
        current_loop_index = 0
