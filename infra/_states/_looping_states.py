...
class States(BaseStates):
    """A collection of states for the looping sequence."""
    ...
    def __init__(self) -> None:
        ...
        self.sequence_state.sequence = [
            ...
            SequenceStepSpecLite(step_name="LR"),
            SequenceStepSpecLite(step_name="OR"),
            SequenceStepSpecLite(step_name="OWI"),
        ]
        self.output: SimpleNamespace = SimpleNamespace()

        # Holds all syntax-related information for the loop.
        self.syntax: SimpleNamespace = SimpleNamespace()
        self.syntax.marker: Optional[str] = None
        """The keyword that triggered the loop (e.g., 'every')."""

        self.syntax.loop_index: Optional[int] = 0
        """The index of the loop, used to distinguish nested loops."""
        ...
        self.workspace: Dict[str, Any] = {}  # Workspace for Looper
        self.is_loop_progress: Optional[bool] = False  # Tracks if looper made progress (new element found)
