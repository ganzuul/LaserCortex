...
def grouping_references(states: States) -> States:
    """Perform the core grouping logic for looping."""
    ...
    # 3. Perform grouping. For looping, this is essentially a flattening operation.
    grouper = Grouper()
    # For looping, we always use or_across pattern
