...
def set_up_imperative_python_demo(agent_frame):
    logger.debug("Setting up imperative_python demo sequence")
    ...
    @register_inference_sequence("imperative_python")
    def imperative_python(self: Inference):
        """`(IWI-IR-MFP-MVP-TVA-TIP-MIA-OR-OWI)`"""
        logger.info("=====EXECUTING IMPERATIVE PYTHON SEQUENCE=====")
        ...
        logger.info("=====IMPERATIVE PYTHON SEQUENCE COMPLETED=====")
        return states

def configure_imperative_python_demo(agent_frame, inference_instance: Inference, methods: dict[str, Callable]):
    logger.debug("Configuring imperative_python demo steps")
