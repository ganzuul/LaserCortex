...
def set_up_imperative_python_indirect_demo(agent_frame):
    logger.debug("Setting up imperative_python_indirect demo sequence")
    ...
    @register_inference_sequence("imperative_python_indirect")
    def imperative_python_indirect(self: Inference):
        """`(IWI-IR-MFP-MVP-TVA-TIP-MIA-OR-OWI)`"""
        logger.info("=====EXECUTING IMPERATIVE PYTHON INDIRECT SEQUENCE=====")
        ...
        logger.info("=====IMPERATIVE PYTHON INDIRECT SEQUENCE COMPLETED=====")
        return states

def configure_imperative_python_indirect_demo(agent_frame, inference_instance: Inference, methods: dict[str, Callable]):
    logger.debug("Configuring imperative_python_indirect demo steps")
