...
def create_repositories_from_files():
    with open(SCRIPT_DIR / 'repos/5.2_concept_repo_sim.json', 'r') as f:
        concept_data = json.load(f)
    concept_repo = ConceptRepo.from_json_list(concept_data)

    with open(SCRIPT_DIR / 'repos/5.2_inference_repo_sim.json', 'r') as f:
...
if __name__ == "__main__":
    ...
    logging.info("=== Starting Simplified Pipeline Execution 5.2 ===")
